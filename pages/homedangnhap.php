  ...
  <div class="input-group">
    ...
    <div class="input-group-btn">
      ...
      <li><a id="btndangnhap" data-toggle="modal" data-target="#myModal" href="#">Đăng nhập</a></li>
      <li><a id="btndangky" data-toggle="modal" data-target="#myModal1" href="#">Đăng ký</a></li>
    </ul>
                    </div><!--navbar-collapse-->
                </div>
            </div>
