...
<div style="text-align:center">
  ...
  <span class="dot1"></span> 
        ...
        $hienthi=$_GET["hienthi"];
           ...
           <div class="row" onclick="yeucaudangnhap()">
...
<script type="text/javascript">
  function phantrang(str) {
  var xhttp; 
  
  xhttp = new XMLHttpRequest();
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
    document.getElementById("rowdealkhung").innerHTML = this.responseText;
    }
  };
  xhttp.open("GET", "dealkhung/phantrangdeal.php?trang="+str, true);
  xhttp.send();
}
</script>
