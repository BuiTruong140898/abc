                       ...
                       $i= mysqli_num_rows($rows);
                        ...
                        while ($row=mysqli_fetch_assoc($rows)) {
                          ...
                          ?> 
                            ...
                            <td width="10%"><?php echo $row["ngaydukienduyet"] ?></td>
                            <td width="10%"><?php echo $row["trangthai"] ?></td>
                            <td width="20%"><button>Sửa</button><button style="background-color: red">Xoá</button></td>
                            </tr>
                           <?php
